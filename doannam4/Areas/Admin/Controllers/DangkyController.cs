...
namespace doannam4.Areas.Admin.Controllers
{
    ...
    public class DangkyController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var mnList = _context.Dangkys.OrderBy(m => m.DkyID).ToList();
            return View(mnList);
        }
        ...
        public IActionResult Delete(long? id)
        {
            ...
            var mn = _context.Dangkys.Find(id);
        ...
        public IActionResult Delete(long id)
        {
            var deleDangky = _context.Dangkys.Find(id);
            if (deleDangky == null)
            {
                return NotFound();
            }
            _context.Dangkys.Remove(deleDangky);
